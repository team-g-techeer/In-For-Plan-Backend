       ...
       // super.configure(httpSecurity);
        httpSecurity.csrf().disable()
                ...
                .and()
                    ...
                    .antMatchers("/**", "/css/**", "/images/**", "/js/**", "/h2-console/**", "/error/**", "/api/v1/users", "/swagger-ui/**").permitAll()
//                    .antMatchers("/api/v1/**", "/swagger-ui/**").hasRole(SocialRole.USER.name())    // /api/v1/** 은 USER 권한만 접근 가능
